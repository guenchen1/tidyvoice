...
import wespeaker.models.wav2vec2 as wav2vec2
import wespeaker.models.wavlm as wavlm
import wespeaker.models.fusion_model as fusion_model
import wespeaker.models.fusion_model_wavlm as fusion_model_wavlm
import wespeaker.models.resnet_lang as resnet_lang

def get_speaker_model(model_name: str):
    if model_name == "ResNetLanguageModel":
        return resnet_lang.ResNetLanguageModel
        ...
        return getattr(wav2vec2, model_name)
    elif model_name.startswith("WavLM"):
        return getattr(wavlm, model_name)
    elif model_name == "FusionSpeakerModel":
        return fusion_model.FusionSpeakerModel
    elif model_name == "FusionWavLMModel":
        return fusion_model_wavlm.FusionWavLMModel
